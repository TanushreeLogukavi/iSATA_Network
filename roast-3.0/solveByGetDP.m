...
str = computer('arch');
roastDir = fileparts(which(mfilename));
switch str
    case 'win64'
        solverPath = fullfile(roastDir, 'lib', 'getdp-3.2.0', 'bin', 'getdp.exe');
    case 'glnxa64'
        solverPath = fullfile(roastDir, 'lib', 'getdp-3.2.0', 'bin', 'getdp');
    case 'maci64'
        solverPath = fullfile(roastDir, 'lib', 'getdp-3.2.0', 'bin', 'getdpMac');
    otherwise
