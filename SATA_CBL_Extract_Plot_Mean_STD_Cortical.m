...
% figure
figure('Name','figureAVG','Position',[400 150 810 480]);
hold on
...
er = errorbar(cortical,avg,stdErr,'HandleVisibility','off');   
er.LineStyle='none';
avg_avg = mean(avg);
